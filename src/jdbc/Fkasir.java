...
public class Fkasir extends javax.swing.JFrame {
        ...
        Thread p = new Thread() {
            public void run() {
                for (;;) {
                    ...
                    int bulan = kal.get(Calendar.MONTH) + 1; // Bulan dimulai dari 0
                    int hari = kal.get(Calendar.DAY_OF_MONTH);
                    int jam = kal.get(Calendar.HOUR_OF_DAY);
                    int menit = kal.get(Calendar.MINUTE);
                    int detik = kal.get(Calendar.SECOND);

                    // Format waktu lebih elegan
                    String tanggal = String.format("%02d/%02d/%04d %02d:%02d:%02d", hari, bulan, tahun, jam, menit, detik);

                    // Menampilkan jam di label
                    tgl.setFont(new java.awt.Font("Arial", java.awt.Font.BOLD, 20)); // Font lebih besar dan tebal
                    tgl.setForeground(new java.awt.Color(57, 255, 20)); // Hijau terang
                    tgl.setHorizontalAlignment(javax.swing.SwingConstants.CENTER); // Teks rata tengah
                    tgl.setText(tanggal);
    ...
    private void initComponents() {
        ...
        lblRunningText = new javax.swing.JLabel();
        ...
        jPanel1.setBackground(new java.awt.Color(102, 102, 205));
        jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        lblRunningText.setFont(new java.awt.Font("Arial", 1, 22)); // NOI18N
        lblRunningText.setForeground(new java.awt.Color(255, 255, 255));
        lblRunningText.setText("APLIKASI KASIR");
        jPanel1.add(lblRunningText, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 10, 200, 40));

        tgl.setEditable(false);
        tgl.setBackground(new java.awt.Color(51, 51, 51));
        ...
        jPanel1.add(tgl, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 10, 240, 40));
        ...
        kdbarang.setBackground(new java.awt.Color(242, 242, 242));
        ...
        jPanel2.setBackground(new java.awt.Color(102, 102, 205));
        ...
        if (a.equals("")) {
            ...
            if (a1 < a2) {
                ...
                JOptionPane.showMessageDialog(null,
                        "<html><body style='font-family: Arial, sans-serif; text-align: center; padding: 20px; background-color: #FFEBEB; border-radius: 10px; border: 2px solid red; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.2);'>"
                        + "<b><font color='red' size='5'>Maaf uang anda tidak cukup</font></b>"
                        + "<br><br><font size='3'>Silakan coba lagi dengan jumlah yang lebih besar.</font>"
                        + "</body></html>",
                        "Peringatan",
                ...
                // Tampilan dialog kembalian dengan ikon dan format HTML
                JOptionPane.showMessageDialog(null,
                        "<html><body style='font-family: Arial, sans-serif; text-align: center; padding: 20px; background-color: #E8F5E9; border-radius: 10px; border: 2px solid green; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.2);'>"
                        + "<b><font color='green' size='5'>Transaksi Sukses!</font></b>"
                        + "<br><br><font size='4'>Kembalian Anda:</font>"
                        + "<br><br><font size='6' color='blue'><b>RP: " + kembali + "</b></font>"
                        + "<br><br><font size='3' color='gray'>Terima kasih telah berbelanja!</font>"
                        + "</body></html>",
                        "Kembalian Anda",
    ...
    private javax.swing.JLabel lblRunningText;
